...
public class X509ClientIT extends AbstractMacServiceTests {
    ...
    public static void initClass() {
        String baseAddress = "https://macbeta.b12x.org/mac/api";
        SSLContext sslContext = X509Config.defaultSslContext();
        macService =  new HttpAlleleCodeService(baseAddress, sslContext);
    }
